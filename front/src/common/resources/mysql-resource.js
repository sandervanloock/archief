angular.module('mysqlResource', [])

.factory('mysqlResource', ['ARCHIVE_SERVER_CONFIG','$http', '$q', function (ARCHIVE_SERVER_CONFIG, $http, $q) {

  function MysqlResourceFactory(tableName) {

    var url =ARCHIVE_SERVER_CONFIG.baseUrl  + tableName;
    var defaultParams = {};
