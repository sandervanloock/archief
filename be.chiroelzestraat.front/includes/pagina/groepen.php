...
<div id="activiteiten" class="gridbox left" ng-controller="GroupCalendarController">
        ...
        <div id="slider1" class="csw">
            <div class="panelContainer">
                <div class="panel" ng-repeat="event in calendar.events">
                    <div class="wrapper">
                        <h2>{{event.summary}}</h2>
                        <img class="left png" ng-src="images/{{group}}.png" alt="logo"/>
                        <p class="description">{{event.description}}</p><br/>
                        <span style="top:130px;" id="start" class="date">Van: {{event.start.dateTime | date : 'dd/M/yyyy H:mm' }}</span><br>
                        <span style="top:145px;" id="end"
                              class="date">Tot: {{event.end.dateTime | date : 'dd/M/yyyy H:mm' }}</span>
